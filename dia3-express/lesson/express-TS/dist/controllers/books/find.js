...
const findBooks = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (isbn) {
            ...
            if (!book)
                return res.status(status_1.default.NOT_FOUND).send('Book not find');
            return res.status(status_1.default.OK).json(book);
        }
        const books = yield (0, reader_1.default)();
        return res.status(status_1.default.OK).json(books);
    }
    catch (e) {
        next(e);
    }
});
exports.default = findBooks;
