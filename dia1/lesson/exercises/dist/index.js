...
console.log(`Losango de D = a 32cm e d = 18cm: ${Exercise.diamond(32, 18)}cm²`);
console.log(`Trapezio de B = a 100cm e b = 70cm e altura = a 50: ${Exercise.trapezium(100, 70, 50)}cm²`);
console.log(`Circulo de R = a 25cm ${Exercise.circle(25)}cm²`);
